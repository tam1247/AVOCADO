...
<head>
  ...
  <link rel="stylesheet" href="cn goi cuoc.css">
...
<body>
  ...
  <div class="package 02">
    ...
    <ul>
      <p> Trẻ sẽ có cơ hội tiếp thu ngôn ngữ mới một cách nhanh chóng và tự tin hơn trong giao tiếp. Việc học tiếng Anh từ sớm cũng giúp trẻ phát triển kỹ năng nghe và nói tốt hơn.</p>
    </ul>
    <a class="button" href="Thanh Toán.php">Đăng ký ngay</a>
  </div>
  </div>
    <div class="package pa">
      <h2></h2>
    ...
    <div class="package 02">
      ...
      <ul>
        ...
        <li>Mở rộng kiến thức và tầm hiểu biết</li>
    ...
    <div class="package 02">
      ...
      <p>Thông tin của gói cước:</p>
      <ul>
        <p>Công cụ giúp trẻ tự tin trò chuyện, giao lưu,tìm hiểu văn hoá với người bản địa một cách suôn sẻ và hiệu quả. Khi có tiếng Anh làm vốn, chúng taở hữu chiếc chìa khóa mở cánh cửa kho tàng tri thức và khoa học thế giới</p>
      </ul>
      <a class="button" href="Thanh Toán.php">Đăng ký ngay</a>
    </div>
    </div>
